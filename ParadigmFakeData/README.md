...
## Overview
Production-ready application for generating and managing fake customer data for Paradigm API using Bogus library with full DI, logging, and SOLID principles.
